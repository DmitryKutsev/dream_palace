...
from dream_palace.bots.clerk import build_dispatcher as build_clerk
from dream_palace.bots.dreamer import build_dispatcher as build_dreamer
...
app = FastAPI(title="Dream Palace webhooks")
...
def verify(secret: str | None) -> None:
    if (
        ...
        or secret is None
        or not compare_digest(secret, settings.webhook_secret)
    ):
...
async def clerk_webhook(
    ...
    verify(x_telegram_bot_api_secret_token)
